                    ...
                    <div class="middull-content">
                        ...
                        <div class="most-visited-content">
                            ...
                            <div class="pagination-area">
                                <a href="{{route('most.visited.answered')}}" class="next page-numbers">
                                    <i class="ri-arrow-left-line"></i>
                                </a>
                                <span class="page-numbers current" aria-current="page">1</span>
                                <a href="{{route('most.visited.answered')}}" class="page-numbers">2</a>
                                <a href="{{route('most.visited.answered')}}" class="page-numbers">3</a>
