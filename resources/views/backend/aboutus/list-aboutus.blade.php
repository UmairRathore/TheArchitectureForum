                ...
                <div class="col-md-12">
                    ...
                    <div class="ms-panel">
                        <div class="ms-panel-header ms-panel-custome">
                            <h6>About us List</h6>
                            <a href="{{route('backend.add-aboutus')}}" class="btn btn-primary">Add About us </a>
                        </div>
                                ...
                                <table id="datatable" class="table table-striped thead-primary w-100">
                                    ...
                                    @foreach ($aboutus as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->aboutus_image && file_exists(storage_path($item->aboutus_image)))
                                                    <img src="{{ asset($item->aboutus_image) }}" alt="Library Profile" style="max-width: 100px;">
                                                @else
                                                    <img src="{{ asset('path/to/placeholder/image.jpg') }}" alt="Library Profile" style="max-width: 100px;">
                                                @endif
                                            </td>
                                            <td>
                                                <a class="fas fa-pencil-alt" href="{{ route('backend.edit-aboutus', $item->id) }}"></a>
                                                <a class="fas fa-trash-alt" href="{{ route('backend.delete-aboutus', $item->id) }}"></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
