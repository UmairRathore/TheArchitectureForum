                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ps-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('backend.aboutus-list')}}">About  Us </a></li>
                ...
                <div class="col-xl-12 col-md-12">
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                            ...
                            <form method="POST" action="{{ route('backend.store-aboutus') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-6">
                                        ...
                                        <textarea name="description"   class="form-control form-control-lg @error('description') is-invalid @enderror" placeholder="Enter Description">{{ old('description') }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="about_image" onchange="displayFileName(this, 'aboutFileName')">
