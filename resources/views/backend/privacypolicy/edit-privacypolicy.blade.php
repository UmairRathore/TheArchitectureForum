                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ps-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('backend.privacy-policy-list')}}"> Privacy  Policy List</a></li>
                    ...
                    <div class="ms-panel">
                        ...
                        <div class="ms-panel-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('backend.update-privacy-policy',$privacypolicy->id) }}" method="post">
                                        @method('put')
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12 mb-6">
                                                <label for="description">Privacy Policy</label>
                                                <textarea name="description" id="description" class="form-control form-control-lg @error('description') is-invalid @enderror" placeholder="Enter Privacy Policy">{{ $privacypolicy->description }}</textarea>
                                                @error('description')
