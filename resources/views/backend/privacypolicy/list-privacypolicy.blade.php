                ...
                <div class="col-md-12">
                    ...
                    <div class="ms-panel">
                        <div class="ms-panel-header ms-panel-custome">
                            <h6>Privacy</h6>
                            <a href="{{route('backend.add-privacy-policy')}}" class="btn btn-primary">Privacy And Policy </a>
                        </div>
                                ...
                                <table id="datatable" class="table table-striped thead-primary w-100">
                                    ...
                                    @foreach ($privacypolicy as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="fa fa-edit" href="{{ route('backend.edit-privacy-policy',$item->id) }}">Edit description</a>
                                                <a class="fas fa-trash alt" href="{{ route('backend.delete-privacy-policy',$item->id) }}">Delete description</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                        @endisset
