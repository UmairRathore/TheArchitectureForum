                ...
                <div class="col-md-12">
                    ...
                    <div class="ms-panel">
                        <div class="ms-panel-header ms-panel-custome">
                            <h6>Tags List</h6>
                            <a href="{{route('backend.add-tags')}}" class="btn btn-primary">Add Tags </a>
                        </div>
                                ...
                                <table id="datatable" class="table table-striped thead-primary w-100">
                                    ...
                                    @foreach ($tags as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="fas fa-pencil-alt" href="{{ route('backend.edit-tags', $item->id) }}"></a>
                                                <a class="fas fa-trash-alt" href="{{ route('backend.delete-tags', $item->id) }}"></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
