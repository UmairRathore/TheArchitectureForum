                ...
                <div class="col-md-12">
                    ...
                    <div class="ms-panel">
                        <div class="ms-panel-header ms-panel-custome">
                            <h6>Topics List</h6>
                            <a href="{{route('backend.add-topics')}}" class="btn btn-primary">Add Topics </a>
                        </div>
                                ...
                                <table id="datatable" class="table table-striped thead-primary w-100">
                                    ...
                                    @foreach ($topics as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->title }}</td>
                                            <td>
                                                <a class="fas fa-pencil-alt" href="{{ route('backend.edit-topics', $item->id) }}"></a>
                                                <a class="fas fa-trash-alt" href="{{ route('backend.delete-topics', $item->id) }}"></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
